...
function deleteFromOrionById(id, type, thing_service_path){
    const options = {
        url: 'http://'+config.getConfig().iota.contextBroker.host+':'+config.getConfig().iota.contextBroker.port+'/v1/updateContext',
        method: 'POST',
        body: '{\n' +
        '    "contextElements": [\n' +
        '        {\n' +
        ...
        headers: {
            ...
            'fiware-service': 'knot',
            'fiware-servicepath': thing_service_path
        }
    };
...
exports.deleteFromOrionById = deleteFromOrionById;
